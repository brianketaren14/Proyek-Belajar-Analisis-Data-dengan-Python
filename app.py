...
create_line_plot(df_Guanyuan_Gucheng_Huairou_Nongzhanguan, 'PM2.5', 'PM2.5 in Guanyuan_Gucheng_Huairou_Nongzhanguan')
create_line_plot(df_Shunyi_Tiantan_Wanliu_Wanshouxigong, 'PM2.5', 'PM2.5 in Shunyi_Tiantan_Wanliu_Wanshouxigong')

st.subheader('TEMP')
create_line_plot(df_Aotizhongxin_Changping_Dingling_Dongsi, 'TEMP', 'TEMP in Aotizhongxin_Changping_Dingling_Dongsi')
create_line_plot(df_Guanyuan_Gucheng_Huairou_Nongzhanguan, 'TEMP', 'TEMP in Guanyuan_Gucheng_Huairou_Nongzhanguan')
create_line_plot(df_Shunyi_Tiantan_Wanliu_Wanshouxigong, 'TEMP', 'TEMP in Shunyi_Tiantan_Wanliu_Wanshouxigong')
